...
dns:
  ...
  parent_hosted_zone_id: "${dns.parent_hosted_zone_id}"
  platform_subdomain: "${dns.platform_subdomain}"
  platform_zone_fqdn: "${dns.platform_zone_fqdn}"
  internal_zone_fqdn: "${dns.internal_zone_fqdn}"
  platform_zone_id: "${dns.platform_zone_id}"
  internal_zone_id: "${dns.internal_zone_id}"
  external_wildcard_domain: "${dns.external_wildcard_domain}"
  internal_wildcard_domain: "${dns.internal_wildcard_domain}"
  platform_wildcard_domain: "${dns.platform_wildcard_domain}"
cert_manager:
