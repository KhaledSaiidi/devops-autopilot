...
TF_VAR_alb_controller_namespace=$(yq -r '.iam.alb_controller_namespace' "$CONFIG_FILE"); export TF_VAR_alb_controller_namespace
TF_VAR_alb_controller_service_account=$(yq -r '.iam.alb_controller_service_account' "$CONFIG_FILE"); export TF_VAR_alb_controller_service_account
